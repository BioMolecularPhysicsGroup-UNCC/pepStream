...
#Author: JP
#Date Last Edit:12.11.19
#Disc:  Parses unique pdb: IDs, Chains, Seq start & end from a blastp output
# Assume -- 
#
# Runtime: simply call this script in the directory with teh result.out from pBLAST
# 
...
for key in footprintStartEnd.keys():
    ...
    thread.start_new_thread(os.system('python fragSO.py --f1 '+ pdbName + ' --s1 '+ startRes +' --s2 '+ endRes +' --c1 '+ chain +' --c 5.5 --i 0 --jobid '+ outputName))
